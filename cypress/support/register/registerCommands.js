...
Cypress.Commands.add("fillInlastName", (nameLast) => {
    cy.get(loc.register.inputLastName).type(nameLast);
});
...
Cypress.Commands.add("fillInPasswordConfirmation", (password) => {
    cy.get(loc.register.inputConfirmPassword).type(password, {log: false});
});
